...
const SEED_QUESTIONS = [
  ...
  // double_down
  {
    stem: '대한민국의 헌법 제1조 1항과 2항을 모두 포함하는 것은 무엇일까요?',
    choices: [
      '대한민국은 민주공화국이다. 모든 권력은 국민으로부터 나온다.',
      '대한민국의 주권은 국민에게 있고, 모든 권력은 국민으로부터 나온다.',
      '대한민국은 민주공화국이다. 대한민국의 주권은 국민에게 있다.',
      '대한민국의 주권은 국민에게 있고, 대한민국의 영토는 한반도와 그 부속도서로 한다.',
    ],
    answerIndex: 1,
    category: 'general',
    ...
    difficulty: 5,
    explanation:
      '헌법 제1조 1항은 "대한민국은 민주공화국이다", 2항은 "대한민국의 주권은 국민에게 있고, 모든 권력은 국민으로부터 나온다." 입니다. 선택지 2번이 두 항을 모두 정확히 포함하고 있습니다.',
  },
] as const;
