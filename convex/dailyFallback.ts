...
export const DEFAULT_WEEKLY_DAILY_QUIZZES: WeeklyFallbackMap = {
  ...
  2: {
    ...
    "category": "variety_reality",
    "questions": [
      {
        "id": "q1",
        "prompt": "2025년 방영된 tvN 예능 '유 퀴즈 온 더 블럭'은 시즌 6을 맞이해 새로운 포맷으로 돌아왔으며, 기존의 거리 인터뷰 대신 스튜디오 대담 중심으로 개편되었다.",
        "correctAnswer": true,
        "explanation": "2025년 시즌 6부터 '유 퀴즈 온 더 블럭'은 거리 인터뷰 대신 초청 게스트와의 스튜디오 토크 중심 포맷으로 전환했습니다.",
        "difficulty": 0.3
      },
      {
        "id": "q2",
        "prompt": "2025년 MBC 예능 '놀면 뭐하니?'에서는 유재석이 새로운 프로젝트 그룹 ‘원더보이즈’를 결성하며 큰 화제를 모았다.",
        "correctAnswer": true,
        "explanation": "2025년 상반기 ‘놀면 뭐하니?’에서는 유재석이 후배들과 함께 결성한 ‘원더보이즈’ 프로젝트로 시청자들의 주목을 받았습니다.",
        "difficulty": 0.4
      },
      {
        "id": "q3",
        "prompt": "넷플릭스 예능 '피지컬: 100 시즌3'에서는 여성 참가자 비율이 역대 최저 수준으로 줄어들었다.",
        "correctAnswer": false,
        "explanation": "'피지컬: 100 시즌3'에서는 여성 참가자 비율이 오히려 역대 최고 수준으로 늘어, 다양한 종목별 대결이 강화되었습니다.",
        "difficulty": 0.5
      },
      {
        "id": "q4",
        "prompt": "2025년 쿠팡플레이 예능 'SNL 코리아' 시즌6에는 아이브(IVE)의 안유진이 호스트로 출연해 방송 직후 주요 클립이 유튜브 조회수 100만 회를 돌파했다.",
        "correctAnswer": true,
        "explanation": "2025년 'SNL 코리아 시즌6'에서 안유진이 호스트로 출연한 회차는 방송 직후 SNS와 유튜브에서 큰 화제를 모았습니다.",
        "difficulty": 0.6
      },
      {
        "id": "q5",
        "prompt": "넷플릭스 리얼리티 예능 '솔로지옥 시즌4'에서는 참가자 전원이 이전 시즌 출연자들이었다.",
        "correctAnswer": false,
        "explanation": "'솔로지옥 시즌4'에는 일부 이전 시즌 출연자들이 재등장했지만, 전원이 기존 참가자는 아니었습니다.",
        "difficulty": 0.45
      },
      {
        "id": "q6",
        "prompt": "2025년 웨이브(Wavve) 오리지널 예능 '하우스메이트'는 서로 다른 세대의 연예인들이 한집에 살며 일상을 공유하는 리얼리티 프로그램이다.",
        "correctAnswer": true,
        "explanation": "'하우스메이트'는 세대 간 공감과 소통을 주제로 한 리얼리티 프로그램으로 2025년 웨이브에서 방영되었습니다.",
        "difficulty": 0.7
      }
    ],
    "shareTemplate": {
      "headline": "오늘의 예능•리얼리티 퀴즈, 60초 스피드런!",
      "cta": "도전?",
      "emoji": "📺"
    }
  },
  ...
  6: {
    ...
    "questions": [
      ...
      {
        "id": "q4",
        "prompt": "e스포츠 '리그 오브 레전드 월드 챔피언십(롤드컵) 2024'에서 T1은 4강전에서 같은 LCK 소속팀을 꺾고 결승에 진출했으며, 이후 결승전에서는 중국팀을 꺾고 우승을 차지하며 5회 우승의 대기록을 썼다.",
        "correctAnswer": true,
        "explanation": "T1은 2024년 롤드컵에서 같은 LCK 소속팀 젠지(Gen.G)를 꺾고 결승에 진출한 뒤, 중국팀 빌리빌리 게이밍(Bilibili Gaming, BLG)을 제압하며 우승을 차지했습니다. 이로써 리그 오브 레전드 e스포츠 역사상 최초로 롤드컵 통산 5회 우승을 달성했습니다.",
        "difficulty": 0.3
      },
      {
        "id": "q5",
        "prompt": "롤드컵 2024 결승전 MVP는 '페이커' 이상혁 선수이며, 이 수상으로 그는 롤드컵 통산 3번째 결승전 MVP를 기록했다.",
        "correctAnswer": false,
        "explanation": "롤드컵 2024 결승전 MVP는 '페이커' 이상혁 선수이지만, 이는 그의 '통산 2번째' 롤드컵 결승전 MVP 수상입니다.",
        "difficulty": 0.7
      },
      {
        "id": "q6",
